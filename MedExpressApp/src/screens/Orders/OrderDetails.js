...
const OrderDetailsScreen = ({ route, navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {selectedOrder.orderStatus ?  <View><Text style={styles.sectionHeader}>Status commande: {selectedOrder.orderStatus}</Text></View> : <View/>}

      {selectedOrder.deliveryStatus ?  <View><Text style={styles.sectionHeader}>Status livraison: {selectedOrder.deliveryStatus}</Text></View> : <View/>}
